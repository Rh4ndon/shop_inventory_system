        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Assistant Product Edit Page</h1>

                    <?php
                            @include '../models/dbcon.php';
	                        $query = mysqli_query($conn,"select * from products where id = $get_id") or die(mysqli_error());
                    ...
                    <div class="card shadow mb-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control form-control-user" name="product_name" value="<?php echo $row['product_name'];?>"type="text" placeholder="Product Name" required>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control form-control-user" name="price" type="number" value="<?php echo $row['price'];?>" min="1" max="99999"placeholder="Market price" required>
                                </div>
                                </div>
